...
function meta.fa.hooks:CreateFonts()
	font.Create("FontAwesome", {
		font = "FontAwesome",
		extended = true,
...
plugin.AddHooks("FontAwesome", meta.fa.hooks)

function meta.fa:GetIcon(id)
	if (faCodes[id]) then
		if (!buffer[id]) then
...
function meta.fa:Draw(id, x, y, size, color, xAlign, yAlign, outlineWidth, outlineColor)
	...
	if (outlineWidth) then
		draw.SimpleTextOutlined(self:GetIcon(id), font.GetSize("FontAwesome", size), x, y, color, xAlign, yAlign, outlineWidth, outlineColor)
	else
		draw.SimpleText(self:GetIcon(id), font.GetSize("FontAwesome", size), x, y, color, xAlign, yAlign)
	end
end