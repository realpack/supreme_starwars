...
function SWEP:PrimaryAttack()
    ...
    -- print(IsValid( ent ), self:Clip1(), ent:IsPlayer(), ent:IsNPC(), ent:Health(), ent.var )
	if ( IsValid( ent ) && self:Clip1() >= 50 && ( ent:IsPlayer() || ent:IsNPC() ) && ent:Health() ) then

		self:TakePrimaryAmmo( 50 )

        -- print(ply:GetMaxHealth())
        -- print(math.Clamp( ply:Health() + 10, 0, (tonumber(ply:GetNVar('maxHealth')) or ply:GetMaxHealth()) ))
        -- print(ply:GetMaxHealth())
		ent:SetHealth( math.Clamp( ent:Health() + 30, 0, (tonumber(ent:GetNVar('maxHealth')) or ent:GetMaxHealth()) ) )
...
function SWEP:Reload()
	...
	if ( IsValid( ent ) && self:Clip1() >= 150 && ( ent:IsPlayer()))  then

		self:TakePrimaryAmmo( 100 )

		ent:GiveAmmo(1, 1, false)
		me:GiveAmmo(1, 1, false)
		//ent:EmitSound( HealSound )
