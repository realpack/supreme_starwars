...
*/
surface.CreateFont( "wepselect", { font = "Play Bold", extended = true, size = 20 } )
surface.CreateFont( "wepselect_selected", { font = "Play Bold", extended = true, size = 21 } )
local ButtonColor = Color(255, 87, 51)
local AmmoButton = Color(100,0,200,150)

local function GetWeaponType(class)
	if (string.find(class,"bf2017_") or class == "fists_weapon" or class == "bf2" or class == "weapon_fists" or class == "ultra_fists" or class == "stungun") then
		return "weapon"
