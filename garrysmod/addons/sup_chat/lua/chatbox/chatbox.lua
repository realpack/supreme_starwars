...
local PANEL={}
	...
	function PANEL:Init()
		...
		self.Chat_ = self.Properties:AddSheet(L"Чат", self.Chat,'icon16/comments.png', false, false, "Chat")
		...
		-- todo: separator
		self.Config_ = self.Properties:AddSheet(L"Настройки", self.Config, 'icon16/wrench_orange.png', false, false, "Config")
