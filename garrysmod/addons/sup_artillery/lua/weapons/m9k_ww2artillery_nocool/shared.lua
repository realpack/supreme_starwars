...
SWEP.Gun = ("m9k_ww2artillery_nocool")					-- must be the name of your swep
SWEP.Category				= "Artillery Strike"
SWEP.Author				= "INCONVIEVABLE & Tader"
SWEP.Contact				= ""
SWEP.Purpose				= "Call in artillery strikes."
...
SWEP.PrintName				= "Artillery Strike (No Cooldown)"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("weapons/radiooperator/targetacquired.mp3")		-- script that calls the primary fire sound
