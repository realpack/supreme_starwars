...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("m9k_ammo_40mm_single")
...
if not IsValid(self) then return end
	...
	effectdata:SetMagnitude(9)			// Length of explosion trails
	util.Effect( "m9k_gdcw_cinematicboom", effectdata )
	--generic default, you are a god among men
	
	util.BlastDamage(self.Entity, (self:OwnerCheck(attacker)), self.Entity:GetPos(), 500, 400)
