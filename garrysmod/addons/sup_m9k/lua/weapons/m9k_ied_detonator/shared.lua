...
if IsMounted( "cstrike" ) then
	...
	SWEP.VElements = {
		["phone"] = { type = "Model", model = "models/weapons/w_camphon2.mdl", bone = "Da Machete", rel = "", pos = Vector(-4.327, 6.361, 15.64), angle = Angle(141.658, -25.886, -28.254), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
		}
