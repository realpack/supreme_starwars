...
local a = {
    action_claim = Material('sup_ui/lock.png', 'smooth noclamp'),
    action_unclaim = Material('sup_ui/unlock.png', 'smooth noclamp'),
    actions = Material('sup_ui/gear.png', 'smooth noclamp'),
    ...
    action_close = Material('sup_ui/skull.png', 'smooth noclamp'),
