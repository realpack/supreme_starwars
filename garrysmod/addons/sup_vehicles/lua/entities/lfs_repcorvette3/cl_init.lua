...
function ENT:Draw()
	...
	render.DrawSprite( self:LocalToWorld( Vector(-1380,100,420) ), Size, Size, Color( 255, 255, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1380,-380,180) ), Size, Size, Color( 255, 255, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1380,580,180) ), Size, Size, Color( 255, 255, 0, 255) )
end
