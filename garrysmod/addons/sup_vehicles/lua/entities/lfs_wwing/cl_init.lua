...
function ENT:Draw()
	...
	local Size = 90 + (self:GetRPM() / self:GetLimitRPM()) * 10 + Boost

	render.SetMaterial( mat )
	render.DrawSprite( self:LocalToWorld( Vector(-70,-108,22) ), Size, Size, Color( 120, 50, 255, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-70,108,22) ), Size, Size, Color( 120, 50, 255, 255) )
