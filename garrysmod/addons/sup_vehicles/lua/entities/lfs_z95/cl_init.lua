...
function ENT:Draw()
	...
	render.DrawSprite( self:LocalToWorld( Vector(-195,49,45) ), Size, Size, Color( 255, 49, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-195,-49,45) ), Size, Size, Color( 255, 49, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-195,49,75) ), Size, Size, Color( 255, 49, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-195,-49,75) ), Size, Size, Color( 255, 49, 0, 255) )
end
