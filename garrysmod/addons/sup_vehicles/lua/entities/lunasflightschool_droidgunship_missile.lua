...
if SERVER then
	...
	function ENT:SpiralFire()
		...
		if IsValid( pObj ) then
			...
			AF.p = math.Clamp( AF.p * 0.25,-90,90 )
			AF.y = math.Clamp( AF.y * 0.25,-90,90 )
			AF.r = math.Clamp( AF.r * 0.25,-90,90 )
	...
	function ENT:Initialize()	
		...
		self.snd = CreateSound(self, "lfs/droidgunship/rockets/rocket_loop.wav")
		self.snd:Play()
	end
