...
function ENT:Draw()
	...
	render.DrawSprite( self:LocalToWorld( Vector(-1380,20,420) ), Size, Size, Color( 255, 255, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1380,-425,180) ), Size, Size, Color( 255, 255, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1380,475,180) ), Size, Size, Color( 255, 255, 0, 255) )
end
