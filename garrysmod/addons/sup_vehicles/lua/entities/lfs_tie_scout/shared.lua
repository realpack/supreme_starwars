...
ENT.MDL = "models/sfp_tiescout/sfp_tiescout.mdl"
...
ENT.RotorPos = Vector(0,0,80)  -- make sure you set these correctly or your plane will act wierd
ENT.WingPos = Vector(100,0,80) -- make sure you set these correctly or your plane will act wierd
ENT.ElevatorPos = Vector(-300,0,80) -- make sure you set these correctly or your plane will act wierd
ENT.RudderPos = Vector(-300,0,80) -- make sure you set these correctly or your plane will act wierd
