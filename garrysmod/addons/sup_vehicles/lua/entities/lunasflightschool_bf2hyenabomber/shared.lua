...
ENT.PrintName = "[BF2] Hyena-class Bomber"
...
ENT.RotorPos = Vector(115,0,-68.86)
ENT.WingPos = Vector(27,0,-68.86)
ENT.ElevatorPos = Vector(-327,0,-68.86)
ENT.RudderPos = Vector(-327,0,-68.86)

--ENT.ElevatorPos = Vector(-227,0,-68.86)
--ENT.RudderPos = Vector(-227,0,-68.86)
