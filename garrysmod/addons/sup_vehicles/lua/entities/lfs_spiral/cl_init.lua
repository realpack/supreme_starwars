...
function ENT:Draw()
	...
	render.DrawSprite( self:LocalToWorld( Vector(-150,30,57) ), Size, Size, Color( 255, 49, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-150,-112,57) ), Size, Size, Color( 255, 49, 0, 255) )
end
