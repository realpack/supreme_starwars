...
-- UNIVERSAL THREE-POINT CLIENT-ENTITY BASED IK SCRIPT BY LUNA/BLU ( https://steamcommunity.com/profiles/76561197995010235 )

--DO NOT EDIT OR REUPLOAD THIS FILE

-- IF YOU WANT TO USE THIS ADD THIS ADDON TO YOUR REQUIREMENTS AND PUT THIS IN YOUR CLIENTSIDE SCRIPT:
