	...
	if self.nextEFX < CurTime() then
		...
		if emitter then
			for _, v in pairs( Pos ) do
				...
				particle:SetStartSize( math.Rand(55,75) )
...
function ENT:Draw()
	...
	local Size = 600 + (self:GetRPM() / self:GetLimitRPM()) * 10 + Boost
		
	render.SetMaterial( mat )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,100,410) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,-100,410) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,290,410) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,-290,410) ), Size, Size, Color( 255, 200, 0, 255) )
	
	render.DrawSprite( self:LocalToWorld( Vector(-1130,200,250) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,-200,250) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,0,250) ), Size, Size, Color( 255, 200, 0, 255) )
	
	render.DrawSprite( self:LocalToWorld( Vector(-1130,100,100) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,-100,100) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,290,100) ), Size, Size, Color( 255, 200, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-1130,-290,100) ), Size, Size, Color( 255, 200, 0, 255) )
end
