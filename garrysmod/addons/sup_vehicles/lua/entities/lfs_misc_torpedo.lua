...
if SERVER then
	...
	function ENT:FollowTarget( followent )
		local speed = self:GetStartVelocity() + (self:GetDirtyMissile() and 4000 or 3000)
	...
	function ENT:Think()	
		...
		if self.Explode then
			...
			util.BlastDamage( IsValid( Inflictor ) and Inflictor or Entity(0), IsValid( Attacker ) and Attacker or Entity(0), self:GetPos(),150,600)
