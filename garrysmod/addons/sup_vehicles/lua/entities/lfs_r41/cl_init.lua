...
function ENT:Draw()
	...
	render.DrawSprite( self:LocalToWorld( Vector(-270,25,41) ), Size, Size, Color( 255, 0, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-270,-30,41) ), Size, Size, Color( 255, 0, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-258,70,63) ), Size, Size, Color( 255, 0, 0, 255) )
	render.DrawSprite( self:LocalToWorld( Vector(-258,-73,63) ), Size, Size, Color( 255, 0, 0, 255) )
