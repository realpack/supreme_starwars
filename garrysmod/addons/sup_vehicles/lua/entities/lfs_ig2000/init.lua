...
function ENT:PrimaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 1
	bullet.Src 	= self:LocalToWorld( Vector(280,90 * Mirror,100) )
...
function ENT:SecondaryAttack()
	...
	local bullet = {}
	bullet.Num 	= 1
	bullet.Src 	= self:LocalToWorld( Vector(120,0,60) )
	bullet.Dir 	= (TracePlane.HitPos - bullet.Src):GetNormalized()
	bullet.Spread 	= Vector( 0.022,  0.022, 0 )
	bullet.Tracer	= 1
