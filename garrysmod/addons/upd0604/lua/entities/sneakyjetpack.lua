...
ENT.AttachmentInfo = {
	...
	OffsetVec = Vector( 7 , -3.5 , -0.2 ),
	OffsetAng = Angle( 0 , 90 , -91 ),
}
...
function ENT:SetupDataTables()
	...
	self:DefineNWVar( "Int" , "JetpackSpeed" , true , "Jetpack idle upward speed" , 1 , 800 )
	self:DefineNWVar( "Int" , "JetpackStrafeSpeed" , true , "Jetpack idle side speed" , 1 , 800 )
...
function ENT:PredictedHitGround( ply , inwater , onfloater , speed )
	...
	if dogroundslam and speed > 200 then
