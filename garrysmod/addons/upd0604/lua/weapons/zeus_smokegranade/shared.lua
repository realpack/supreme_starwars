...
function SWEP:ThrowFar()
	...
	local ent = ents.Create ("zeus_smokegrenade")
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/zeus/w_smokegrenade1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 2, -0.519), angle = Angle(174.156, 94.675, 15.194), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/zeus/w_smokegrenade1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 2, -1.558), angle = Angle(-162.469, 0, 0), size = Vector(0.82, 0.82, 0.82), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
