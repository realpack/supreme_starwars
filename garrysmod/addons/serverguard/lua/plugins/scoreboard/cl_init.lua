...
function panel:Paint(w, h)
	...
	draw.SimpleText(GAMEMODE.Name or engine.ActiveGamemode(), "serverguard.scoreboard.gamemode", w /2, 56, theme.tiger_base_section_label, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
