...
SWEP.SlotPos = 1
SWEP.Spawnable = true
SWEP.WorldModel = 'models/tfa/comm/gg/droid_b2_fp_hand.mdl'
SWEP.ViewModel = ''
...
function SWEP:PrimaryAttack()
	...
	local side = aim:Cross(Vector(0, owner:IsPlayer() and owner:Crouching() and 2.5 or 0,1))
