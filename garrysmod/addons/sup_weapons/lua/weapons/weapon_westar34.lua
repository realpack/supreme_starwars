--[[
addons/swb_starwars/lua/weapons/weapon_westar34.lua
--]]
AddCSLuaFile()
...
if ( CLIENT ) then
	...
	killicon.Add( "weapon_westar34", "HUD/killicons/WESTAR34", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_WESTAR34.mdl"
...
local FireSound 			= Sound ("weapons/WESTAR34_fire.wav");

local ReloadSound			= Sound ("weapons/WESTAR34_reload.wav");
...
SWEP.IronSightsPos 			= Vector (-3.68, -4, 2.4)
...
function SWEP:CSShootBullet( dmg, recoil, numbul, cone )
	...
	bullet.Spread 	= self:GetOwner():IsNPC() and Vector(0,0,0) or Vector( cone, cone, 0 )			// Aim Cone
