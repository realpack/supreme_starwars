--[[
addons/swb_starwars/lua/weapons/weapon_se14c.lua
--]]
if ( SERVER ) then
...
if ( CLIENT ) then
	...
	SWEP.WepSelectIcon = surface.GetTextureID("HUD/killicons/SE14C")

	

	killicon.Add( "weapon_se14c", "HUD/killicons/se14c", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/v_SE14C.mdl"

SWEP.WorldModel				= "models/weapons/w_SE14C.mdl"



local FireSound 			= Sound ("weapons/SE14C_fire.wav");

local ReloadSound			= Sound ("weapons/SE14C_reload.wav");
