...
SWEP.FireModeNames = {
	["auto"] = {display = "FULL-AUTO", auto = true, burstamt = 0, buldis = 5},
	...
	["stan"] = {display = "STAN MODE", auto = false, burstamt = 0, buldis = 0, damage = 0, delay = 4, tracer = 'sup_laser_purple'}
}
...
function SWEP:Initialize()
	...
	self.DefaultDamage = self.DamageFallOff
	self.DefaultFireDelay = self.FireDelay
	self.DefaultTracerName = self.TracerName
...
function SWEP:SelectFiremode(n)
	...
	self.DamageFallOff = t.damage or self.DefaultDamage
	self.FireDelay = t.delay or self.DefaultFireDelay
	self.TracerName = t.tracer or self.DefaultTracerName
